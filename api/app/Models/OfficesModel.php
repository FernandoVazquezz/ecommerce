<?php
    ...
    class OfficesModel extends Models{
        public function selectOffices(){
            ...
            $cons = $this->db->pdo->prepare('SELECT * FROM offices');
            $cons->execute();
        ...
        public function insertOffices($office){
            ...
            $result->bindParam(':officeCode', $office['officeCode'], \PDO::PARAM_INT);
            $result->bindParam(':city', $office['city'], \PDO::PARAM_STR);
            $result->bindParam(':phone', $office['phone'], \PDO::PARAM_INT);
            $result->bindParam(':addressLine1', $office['addressLine1'], \PDO::PARAM_INT);
            $result->bindParam(':addressLine2', $office['addressLine2'], \PDO::PARAM_INT);
            $result->bindParam(':state', $office['state'], \PDO::PARAM_STR);
            $result->bindParam(':country', $office['country'], \PDO::PARAM_STR);
            $result->bindParam(':postalCode', $office['postalCode'], \PDO::PARAM_INT);
